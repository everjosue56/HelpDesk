        ...
        public void Configure(EntityTypeBuilder<NotificationEntity> builder)
        {
            builder.HasData(
                new NotificationEntity
                {
                    ...
                    IdUser = 1,         
                    IdAlertType = 1,     
                    TextMessage = "Se te ha asignado el Ticket #101: Fallo de red en el Laboratorio de Cómputo.",
                    IsRead = false,
                    SentAt = null,       
                    IdReference = 101,   
                ...
                new NotificationEntity
                {
                    ...
                    IdUser = 1,
                    IdAlertType = 2,   
                    TextMessage = "El mantenimiento preventivo de la Laptop Dell (Id: 1) ha sido completado con éxito.",
                    IsRead = true,
