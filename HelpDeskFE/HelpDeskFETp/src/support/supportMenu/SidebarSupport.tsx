...
import { FiHome, FiClock, FiTag, FiTool, FiAlertTriangle, FiDatabase } from 'react-icons/fi';
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          path: "/dashboard/tickethistories",
          icon: FiClock
        },
        {
          name: "Tipo de Error",
          path: "/dashboard/typeerror",
          icon: FiAlertTriangle
        },
        {
          name: "Sistema Afectado",
          path: "/dashboard/softwaresystem",
          icon: FiDatabase
        },
      ]
    }
