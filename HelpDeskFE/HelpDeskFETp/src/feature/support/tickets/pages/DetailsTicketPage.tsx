...
export const DetailsTicketPage: React.FC = () => {
    ...
    const rawRol = localStorage.getItem('IRoles');
    const tienePermisoTI =
        rawRol === '1' ||
        rawRol === '2' ||
            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8 space-y-8 relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-12">
                    ...
                    <div className="space-y-2">
                        ...
                        <div>
                            <span className={`inline-flex items-center justify-center px-6 py-1.5 rounded-full text-xs font-bold min-w-32 text-white shadow-sm ${ticket.isActive ? 'bg-[#2ecc71]' : 'bg-[#e74c3c]'
                                }`}>
